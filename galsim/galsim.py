...
gal1 = sphere(pos=(-1*dx, 0, 0), radius=rgalcore*gal1_size, color=color.blue, make_trail=True, interval=1000, retain=2000)
gal2 = sphere(pos=(dx, 0, 0), radius=rgalcore*gal2_size, color = color.magenta, make_trail=True, interval=1000, retain=2000)
...
#for j in range(nRings)         #number of rings of particles, change for loop to make new rings.
